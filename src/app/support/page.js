...
import How_can_I_exchange_an_item_for_another_size from "@/components/popular_faqs/How_can_I_exchange_an_item_for_another_size/How_can_I_exchange_an_item_for_another_size";
...
import Support_message_form from "@/components/support_message_form/Form";

const popularFaqs = [
  { title: "Where is my Order?", info: Where_is_my_Order },
  { title: "How can I return an item?", info: How_can_I_return_an_item },
  {
    title: "How can I exchange an item for another size?",
    info: How_can_I_exchange_an_item_for_another_size,
  },
...
const Support = () => {
  return (
    <div className={s.support_page}>
      ...
      <Support_message_form />

      <div className={s.feedback}>
        You can get in touch via email on <span>Help@ZXC.com</span> or via
        ourLive <span>Chatweb</span> service.
      </div>

      <p className={s.query_important}>
        Every query is important to us and we aim to respond to all chats and
